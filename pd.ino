...
float ir_distance_sequence(void){
  ...
  // sensor values
float x[SEQ_SIZE] = {69.24, 122.94, 141.77, 160.06, 188.45, 215.17, 270.18, 339.89, 385.28, 432.87};
float y[SEQ_SIZE] = {100.0, 150.0, 175.0,  200.0, 225.0, 250.0, 300.0, 350.0, 400.0, 435.0};
